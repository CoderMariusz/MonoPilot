...
console.log('🚀 Starting migration 054-059...\n');

// Helper to execute SQL through Supabase client
...
// =============================================================================
// PHASE 1: Create new tables (roles, modules, organization_modules)
// =============================================================================
console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
console.log('PHASE 1: Creating new tables');
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');

// Note: exec_sql RPC function might not exist
// We'll use direct table operations instead
...
try {
  ...
  if (checkError && checkError.message.includes('does not exist')) {
    console.log('   Creating new roles table via SQL...');
    // We need to use a SQL function or create tables via Supabase dashboard/CLI
    console.log('   ⚠️  Table creation requires SQL execution');
  } else {
    console.log('   ✅ Roles table already exists');
  }
} catch (err) {
  console.log('   ⚠️  Could not check roles table');
}

console.log('\n⚠️  IMPORTANT: Direct SQL execution via RPC requires setup_exec_sql.sql to be run first');
console.log('   This script will generate SQL that can be run manually.');
...
SET
  ...
  onboarding_step = COALESCE(wizard_progress, 0),
...
const sqlFile = 'C:\\Users\\Mariusz K\\Documents\\Programowanie\\MonoPilot\\migration-054-059.sql';
writeFileSync(sqlFile, migrationSql);

console.log('✅ SQL migration file generated: migration-054-059.sql');
console.log('\n📋 Next steps:');
console.log('   1. Review the generated SQL file');
console.log('   2. Run it via Supabase Dashboard > SQL Editor');
console.log('   3. Or run via CLI: supabase db execute --file migration-054-059.sql');
console.log('\n⚠️  Note: RLS policies from migration 058 should be applied after schema changes');
