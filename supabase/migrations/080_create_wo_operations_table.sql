...
DROP POLICY IF EXISTS "wo_ops_select" ON wo_operations;
DROP POLICY IF EXISTS "wo_ops_insert" ON wo_operations;
DROP POLICY IF EXISTS "wo_ops_update" ON wo_operations;
DROP POLICY IF EXISTS "wo_ops_delete" ON wo_operations;
