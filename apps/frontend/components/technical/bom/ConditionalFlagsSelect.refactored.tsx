...
/**
 * ConditionalFlagsSelect Component (Story 02.5b - REFACTORED)
 *
 ...
 * - Extracted constants to centralized location
 * - Used normalizeConditionFlags helper
 * - Used getFlagColor helper
 */
