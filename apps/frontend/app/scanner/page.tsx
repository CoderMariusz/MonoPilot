...
import { Workflow, Package, ClipboardCheck, Palette } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <Link href="/scanner/receive">
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 sm:p-8 hover:shadow-md transition-shadow cursor-pointer min-h-[200px] flex flex-col items-center justify-center text-center">
              ...
              <h2 className="text-xl sm:text-2xl font-semibold text-slate-900 mb-2">Receive</h2>
          ...
          <Link href="/scanner/process">
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 sm:p-8 hover:shadow-md transition-shadow cursor-pointer min-h-[200px] flex flex-col items-center justify-center text-center">
              ...
              <h2 className="text-xl sm:text-2xl font-semibold text-slate-900 mb-2">Process</h2>
              <p className="text-sm sm:text-base text-slate-600">Scan WO and consume materials</p>
            </div>
          </Link>
          ...
          <Link href="/scanner/pack">
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 sm:p-8 hover:shadow-md transition-shadow cursor-pointer min-h-[200px] flex flex-col items-center justify-center text-center">
              ...
              <h2 className="text-xl sm:text-2xl font-semibold text-slate-900 mb-2">Pack</h2>
          ...
          <Link href="/scanner/pallet">
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 sm:p-8 hover:shadow-md transition-shadow cursor-pointer min-h-[200px] flex flex-col items-center justify-center text-center">
              ...
              <h2 className="text-xl sm:text-2xl font-semibold text-slate-900 mb-2">Pallet</h2>
              <p className="text-sm sm:text-base text-slate-600">Create pallets and manage shipping</p>
            </div>
          </Link>
        </div>
      </div>
