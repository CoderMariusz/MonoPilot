 ...
 *
 * GET /api/settings/warehouses/[warehouseId] - Get warehouse by ID
 * PATCH /api/settings/warehouses/[warehouseId] - Update warehouse
 * DELETE /api/settings/warehouses/[warehouseId] - Delete warehouse
 */
...
export async function GET(
  ...
  try {
    ...
    console.error('Error in GET /api/settings/warehouses/[warehouseId]:', error)
    return NextResponse.json(
...
// ============================================================================
// PATCH /api/settings/warehouses/[warehouseId] - Update Warehouse (AC-004.5)
// ============================================================================
...
export async function PATCH(
  ...
  try {
    ...
    // Call service method
    const result = await updateWarehouse(warehouseId, validatedData)
    ...
    console.error('Error in PATCH /api/settings/warehouses/[warehouseId]:', error)
...
// ============================================================================
// DELETE /api/settings/warehouses/[warehouseId] - Delete Warehouse (AC-004.4)
// ============================================================================
...
export async function DELETE(
  ...
  try {
    ...
    console.error('Error in DELETE /api/settings/warehouses/[warehouseId]:', error)
    return NextResponse.json(
      { error: 'Internal server error' },
      { status: 500 }
    )
