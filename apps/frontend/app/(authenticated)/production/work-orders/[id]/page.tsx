 ...
 * BUG-016 Fix: Added missing page.tsx for /production/work-orders/[id]
 *
 * Display WO header information with production-focused tabs
 * Similar to planning version but with production context and navigation
 */
...
const STATUS_TRANSITIONS: Record<string, string[]> = {
  ...
  in_progress: ['paused', 'on_hold', 'completed'],
...
export default function ProductionWorkOrderDetailsPage(
  ...
  const isPausedOrOnHold = wo.status === 'paused' || wo.status === 'on_hold'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b px-6 py-4">
        <div className="flex items-center justify-between gap-4 flex-wrap max-w-[1600px] mx-auto">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Resume - only for paused/on_hold */}
            {isPausedOrOnHold && (
              <Button
            ...
            {/* Complete WO - for in_progress or paused/on_hold */}
            {(wo.status === 'in_progress' || isPausedOrOnHold) && (
              <Button
      ...
      <div className="px-6 py-6 space-y-6 max-w-[1600px] mx-auto">
        {/* Tabs - Production tab first for production context */}
        <Tabs defaultValue="production" className="space-y-6">
          ...
          {/* Production Tab - First for production context */}
