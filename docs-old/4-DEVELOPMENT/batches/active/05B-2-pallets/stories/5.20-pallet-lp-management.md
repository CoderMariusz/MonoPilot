...
- **Given** viewing pallet items with LP added
- **When** clicking "Remove" button on item
- **Then**:
  - LP unassigned from pallet (pallet_items record deleted)
  - LP.location_id NOT changed (remains at current pallet location)
  - Pallet item count decremented
  - Confirmation dialog shown before deletion
  - **Important**: LP stays in its current location after removal (may be different from pallet's original location if pallet moved)
