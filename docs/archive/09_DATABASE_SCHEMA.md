...
- **transfer_orders** ↔ **transfer_order_items**: _korzystają z_ `from_location_id`/`to_location_id` + planowane/rzeczywiste daty.
...
- products 1—_ bom, bom 1—_ bom_items
- products 1—_ routings, routings 1—_ routing_operations
- work_orders 1—_ wo_operations; work_orders 1—_ wo_materials; work_orders 1—\* production_outputs
- purchase_orders 1—_ purchase_order_items; transfer_orders 1—_ transfer_order_items
- grns 1—_ grn_items; asns 1—_ asn_items (ASN→GRN powiązanie po `po_id`/dostawie)
