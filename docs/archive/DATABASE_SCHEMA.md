...
- idx_boms_product_version ON (product_id, version)
...
- idx_bom_items_bom_sequence ON (bom_id, sequence)
...
- idx_work_orders_line ON (line_id)
...
- idx_wo_materials_wo_material ON (wo_id, material_id)
- idx_wo_materials_snapshot ON (wo_id, created_at)
