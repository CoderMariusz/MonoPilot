...
- `npd_projects.updated_by` → `users.id`
- `npd_formulations.locked_by` → `users.id`
- `npd_formulations.created_by` → `users.id`
...
- `wo_templates.product_id` → `products.id`
- `npd_formulation_items.product_id` → `products.id`
...
- `npd_formulations.npd_project_id` → `npd_projects.id`
- `npd_costing.npd_project_id` → `npd_projects.id`
- `npd_risks.npd_project_id` → `npd_projects.id`
- `npd_documents.npd_project_id` → `npd_projects.id`
