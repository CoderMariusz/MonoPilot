...
| ADR-013 | RLS Org Isolation Pattern | 01.1, 01.5, 01.6, 01.7 |
...
|------:|------|---------|-----|--------------|------------|
| 01.1 | Org context + base RLS scaffolding | FR-SET-002 | (none) | -- | M |
| 01.2 | Settings shell: navigation + guards | FR-SET-030, FR-SET-031 | (implicit) | 01.1 | S |
| 01.3 | Onboarding wizard launcher | FR-SET-180, FR-SET-186, FR-SET-187 | SET-001 | 01.2 | M |
| 01.4 | Organization profile step | FR-SET-001, FR-SET-003, FR-SET-004, FR-SET-181 | SET-002, SET-007 | 01.3 | M |
| 01.5 | Users: list + create/edit modal | FR-SET-010, FR-SET-017 | SET-008, SET-009 | 01.6 | L |
| 01.6 | Role-based permissions (10 roles) | FR-SET-011, FR-SET-020 to FR-SET-031 | SET-011 | 01.1 | M |
| 01.7 | Module toggles | FR-SET-090 to FR-SET-097 | SET-022 | 01.6 | M |
