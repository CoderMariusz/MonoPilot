# Epic 01a Test Strategy - Settings Module (Demo MVP)
...
Test strategy for Epic 01a - a focused demo subset of the Settings Module covering only Phase 1A core features. This epic demonstrates the workflow structure with 7 stories.
...
|-------|---------|-----------------|
| 01a.1 | Org context + base RLS | 95% |
| 01a.2 | Settings shell navigation | 80% |
| 01a.3 | Onboarding wizard launcher | 85% |
| 01a.4 | Organization profile step | 80% |
| 01a.5 | Users CRUD | 85% |
| 01a.6 | Role-based permissions (10 roles) | 90% |
| 01a.7 | Module toggles | 80% |
...
### 1. RLS Isolation (01a.1) - Priority: CRITICAL

```typescript
describe('01a.1 Multi-Tenant Isolation', () => {
...
### 2. Role Permissions (01a.6) - Priority: HIGH

```typescript
describe('01a.6 Role-Based Permissions', () => {
  it.each([
...
### 3. Settings Navigation Guards (01a.2) - Priority: HIGH

```typescript
describe('01a.2 Settings Shell Navigation', () => {
...
### 4. Onboarding Wizard Launcher (01a.3) - Priority: MEDIUM

```typescript
describe('01a.3 Onboarding Wizard Launcher', () => {
...
### 5. Module Toggles (01a.7) - Priority: MEDIUM

```typescript
describe('01a.7 Module Toggles', () => {
...
tests/01a-settings/
  fixtures/
    ...
    users.ts
    modules.ts
  01a.1.org-context-base-rls.test.ts
  01a.1.org-context-base-rls.integration.test.ts
  01a.2.settings-shell-navigation.test.ts
  01a.3.onboarding-wizard-launcher.test.ts
  01a.4.organization-profile-step.test.ts
  01a.5.users-crud.test.ts
  01a.5.users-crud.integration.test.ts
  01a.6.role-permissions.test.ts
  01a.7.module-toggles.test.ts
```
...
```bash
# Run all 01a tests
npm test -- tests/01a-settings/

# Run specific story tests
npm test -- tests/01a-settings/01a.1

# Run with coverage
npm test -- tests/01a-settings/ --coverage

# Run E2E
npx playwright test tests/01a-settings/e2e/
```
...
1. **Start with 01a.1** - foundation for all other stories
...
|---------|------|---------|
| 1.0 | 2025-12-15 | Initial test strategy for demo Epic 01a |
