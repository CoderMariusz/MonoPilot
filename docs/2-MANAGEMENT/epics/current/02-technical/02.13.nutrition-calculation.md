...
## Goal
Implement nutrition facts calculation from BOM ingredients, nutrition panel display with FDA/EU label formats, manual override capability, serving size calculator, and label generation for printing/export.
