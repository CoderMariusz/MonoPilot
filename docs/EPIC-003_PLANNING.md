...
class CostsAPI {
  // Material Costs
  static async setMaterialCost(productId, cost, effectiveFrom): Promise<MaterialCost>
  ...
  static async setProductPrice(productId, price, effectiveFrom): Promise<ProductPrice>
...
class OptimizationAPI {
  // Recommendations
  static async getCostOptimizationRecommendations(bomId): Promise<Recommendation[]>
