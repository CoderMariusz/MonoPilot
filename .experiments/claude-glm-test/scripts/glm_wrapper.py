...
- Frontend: Next.js 15.5 (App Router), React 19, TypeScript 5.x
...
- Use Next.js 15.5 App Router (app/ directory, NOT pages/)
...
Requirements:
- Next.js 15.5 App Router pages (server components where possible)
