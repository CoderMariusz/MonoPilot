...
- 2025-11-29: Implementation completed (dev-story workflow)
  - Phase 1: Database - Added started_at, started_by_user_id columns to work_orders
  - Phase 2: Service Layer - Created wo-start-service.ts with:
    * getWOForStartModal() - Fetches WO + material availability
    * startWorkOrder() - Atomic status transition + audit log
    * Error handling with specific error codes
  - Phase 3: API Routes - Created two endpoints:
    * GET /api/production/work-orders/:id/modal-data (AC-4.2.1)
    * POST /api/production/work-orders/:id/start (AC-4.2.2, AC-4.2.5)
  - Phase 4: Frontend Components:
    * WOStartModal.tsx - Material availability display + loading states (AC-4.2.1, AC-4.2.8)
    * Integrated with WO detail page - "Start Production" button (AC-4.2.2, AC-4.2.3)
  - Phase 5: Testing - Created comprehensive E2E tests (wo-start.spec.ts)
    * AC-4.2.1: Modal display + content
    * AC-4.2.2: Status transition validation
    * AC-4.2.3: WO appears in active list
    * AC-4.2.4: Error handling
    * AC-4.2.5: API endpoint structure
    * AC-4.2.6: Authentication (401)
    * AC-4.2.7: Role-based authorization (403)
    * AC-4.2.8: Loading states
