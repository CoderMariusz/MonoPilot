...
**Story 5.29 must be implemented AFTER the following stories are complete:**
1. **Story 5.5: LP Split** - genealogy source (AC 1)
2. **Story 5.6: LP Merge** - genealogy source (AC 2)
3. **Story 4.7: WO Material Consumption** - genealogy source (AC 3)
4. **Story 4.12: WO Output Recording** - genealogy source (AC 4)

**Reason:** This story adds genealogy recording **callbacks** to those operations. Those operations must exist first before Story 5.29 can integrate with them. Do not attempt to implement 5.29 until all 4 parent stories are complete.
